...
class ecemsg(genpy.Message):
  _md5sum = "8f00b78410e3cd01986d5339f8ac6fc7"
...
bool permission_feu"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2BIH4B2qi2qiB().pack(_x.its_header.protocol_version, _x.its_header.message_id, _x.its_header.station_id, _x.generation_delta_time, _x.basic_container.ID_exp, _x.basic_container.ID_dest, _x.basic_container.phase.value, _x.basic_container.station_type.value, _x.init.destination.latitude, _x.init.destination.longitude, _x.init.destination.altitude, _x.init.actual_position.latitude, _x.init.actual_position.longitude, _x.init.actual_position.altitude, _x.init.platoon.id_platoon))
      length = len(self.init.platoon.ids)
      buff.write(_struct_I.pack(length))
      for val1 in self.init.platoon.ids:
        _x = val1
        buff.write(_get_struct_2B().pack(_x.ID, _x.position))
      _x = self
      buff.write(_get_struct_B2qiH2B2qi2BHB2qi4B().pack(_x.init.platoon.nombre_vehicules, _x.init.platoon.destination.latitude, _x.init.platoon.destination.longitude, _x.init.platoon.destination.altitude, _x.init.platoon.vitesse_interdistance.speed.value, _x.init.platoon.vitesse_interdistance.speed.confidence, _x.init.platoon.vitesse_interdistance.interdistance, _x.insertion.point_insertion.latitude, _x.insertion.point_insertion.longitude, _x.insertion.point_insertion.altitude, _x.insertion.confirmation_insertion, _x.desinsertion.demande_sortie, _x.desinsertion.speed.value, _x.desinsertion.speed.confidence, _x.desinsertion.point_sortie.latitude, _x.desinsertion.point_sortie.longitude, _x.desinsertion.point_sortie.altitude, _x.desinsertion.position, _x.desinsertion.confirmation_sortie, _x.freinage_urgence.position, _x.feu.permission_feu))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.init.platoon.ids.append(val1)
      _x = self
      start = end
      end += 74
      (_x.init.platoon.nombre_vehicules, _x.init.platoon.destination.latitude, _x.init.platoon.destination.longitude, _x.init.platoon.destination.altitude, _x.init.platoon.vitesse_interdistance.speed.value, _x.init.platoon.vitesse_interdistance.speed.confidence, _x.init.platoon.vitesse_interdistance.interdistance, _x.insertion.point_insertion.latitude, _x.insertion.point_insertion.longitude, _x.insertion.point_insertion.altitude, _x.insertion.confirmation_insertion, _x.desinsertion.demande_sortie, _x.desinsertion.speed.value, _x.desinsertion.speed.confidence, _x.desinsertion.point_sortie.latitude, _x.desinsertion.point_sortie.longitude, _x.desinsertion.point_sortie.altitude, _x.desinsertion.position, _x.desinsertion.confirmation_sortie, _x.freinage_urgence.position, _x.feu.permission_feu,) = _get_struct_B2qiH2B2qi2BHB2qi4B().unpack(str[start:end])
...
def _get_struct_2B():
    ...
    return _struct_2B
_struct_2BIH4B2qi2qiB = None
def _get_struct_2BIH4B2qi2qiB():
    global _struct_2BIH4B2qi2qiB
    if _struct_2BIH4B2qi2qiB is None:
        _struct_2BIH4B2qi2qiB = struct.Struct("<2BIH4B2qi2qiB")
    return _struct_2BIH4B2qi2qiB
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
    ...
    return _struct_3I
_struct_B2qiH2B2qi2BHB2qi4B = None
def _get_struct_B2qiH2B2qi2BHB2qi4B():
    global _struct_B2qiH2B2qi2BHB2qi4B
    if _struct_B2qiH2B2qi2BHB2qi4B is None:
        _struct_B2qiH2B2qi2BHB2qi4B = struct.Struct("<B2qiH2B2qi2BHB2qi4B")
    return _struct_B2qiH2B2qi2BHB2qi4B
