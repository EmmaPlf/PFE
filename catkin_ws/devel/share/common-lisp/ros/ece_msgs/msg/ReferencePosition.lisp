...
(cl:defclass <ReferencePosition> (roslisp-msg-protocol:ros-message)
  ((latitude
   ...
   (position_confidence
    ...
    :type ece_msgs-msg:PositionConfidenceEllipse
    :initform (cl:make-instance 'ece_msgs-msg:PositionConfidenceEllipse))
   (altitude
    :reader altitude
    :initarg :altitude
    :type ece_msgs-msg:Altitude
    :initform (cl:make-instance 'ece_msgs-msg:Altitude)))
)
...
(cl:defmethod position_confidence-val ((m <ReferencePosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ece_msgs-msg:position_confidence-val is deprecated.  Use ece_msgs-msg:position_confidence instead.")
