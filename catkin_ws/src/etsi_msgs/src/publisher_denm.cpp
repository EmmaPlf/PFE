...
int main(int argc, char **argv) {
  ...
  DENM.management.event_position.position_confidence.semi_major_confidence =
      0; // cm uint16_t
  DENM.management.event_position.position_confidence.semi_minor_confidence =
      0; // cm uint16_t
  DENM.management.event_position.position_confidence.semi_major_orientation =
  ...
  DENM.situation.linked_cause.sub_cause_code = 0; // uint8_t
  //   DENM.situation.event_history[0].event_position.delta_latitude =
  //       0; // 0.1 micro degree int32_t
  //   DENM.situation.event_history[0].event_position.delta_longitude =
  //       0; // 0.1 micro degree int32_t
  //   DENM.situation.event_history[0].event_position.delta_altitude =
  //       0; // centimeter int16_t
  //   DENM.situation.event_history[0].event_delta_time.value = 0; // 10 ms
  //   uint16_t DENM.situation.event_history[0].information_quality.value = 0;
  //   // int8_t
  ...
  //   DENM.location.traces[0].points[0].path_position.delta_latitude =
  //       0; // 0.1 micro degree int32_t
  //   DENM.location.traces[0].points[0].path_position.delta_longitude =
  //       0; // 0.1 micro degree int32_t
  //   DENM.location.traces[0].points[0].path_position.delta_altitude =
  //       0; // centimeter int16_t
  //   DENM.location.traces[0].points[0].path_delta_time.value = 0; // 10 ms
  //   uint16_t
