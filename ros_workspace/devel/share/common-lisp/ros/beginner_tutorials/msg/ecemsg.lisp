...
(cl:defmethod cl:initialize-instance :after ((m <ecemsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ecemsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<ecemsg> is deprecated: use beginner_tutorials-msg:ecemsg instead.")))
...
(cl:defmethod data-val ((m <ecemsg>))
